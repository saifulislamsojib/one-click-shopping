...
const Orders = ({allOrders}) => {
    ...
    useEffect(() => {
        const url = allOrders ? 'https://apricot-crisp-29597.herokuapp.com/allOrders' : `https://apricot-crisp-29597.herokuapp.com/orders?email=${loggedInUser.email}`
        fetch(url)
        .then(res => res.json())
        .then(data => {
